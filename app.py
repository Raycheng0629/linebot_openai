...
def choose_fortune(weather):
    fortunes = {
        '晴天': [
            '陽光明媚，心情愉悅，今天適合外出活動，盡情享受陽光的溫暖。去運動、旅行或與好友聚會，你會充滿活力和快樂。',
            '鳥語花香，樂觀向上，勇敢追尋夢想，今天會是你收獲的一天。積極投入工作或學習，你將收穫豐盛的成果。',
            '陽光灑落，希望無限，心想事成，把握機會，一切皆有可能。勇敢表達自己的想法和願望，你會被周圍的人支持與鼓勵。',
            '晴空萬里，心情明朗，與朋友共度愉快時光，今天是個充滿笑聲的日子。與家人或朋友共同享受美食和美好時光，你的心情會更加愉快。',
        ...
        '雨天': [
            ...
            '雨聲綿綿，如詩如畫，靜心沉澱，你會找到內心的平靜與安寧。寫下你的想法和感受，讓情緒得到釋放，你會感到心情愈加舒暢。',
        ...
        '陰天': [
            '陰天總讓人感到平靜，是理想的反思時刻，好好聆聽內心的聲音，你會找到答案。找到一個安靜的角落，思考人生的意義和方向，你會有所領悟。',
            '陰雲籠罩，心情平和，適合靜心思考，你會發現一片新的天地。閱讀一本好書或聆聽輕音樂，你會找到內心的平靜和安寧。',
            '陰天帶來思考，挑戰也是成長的機會，勇敢面對，你會變得更加堅強。接受生活的挑戰，勇敢面對困難，你會收穫成長和成功的喜悅。',
            '陰天雖然暗淡，但別忘了陽光總會再度閃耀，相信明天會更好。保持樂觀的態度，相信自己和未來，你會發現光明在不遠處。',
            '陰天讓人感到安靜，適合尋找內心的平靜，好好放鬆，你會發現心靈的寧靜。做些瑜伽或冥想，讓身心得到放鬆和平靜，你的心情會更加愉悅。'
        ],
        '多雲': [
...
def handle_message(event):
    ...
    if message == '健康提醒':
        ...
        del user_weather[user_id]  # 回覆運勢後，刪除記錄的天氣狀況
